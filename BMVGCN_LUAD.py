...
parser.add_argument('--src_folder',type=str,default=".\\tasks\\LUAD_TT_TN",
                    help='source data path for classification')
parser.add_argument('--tar_folder',type=str,default=".\\data_LUAD",
                    help='processed data for classification')
parser.add_argument('--center_folder',type=str,default=".\\center_LUAD",
